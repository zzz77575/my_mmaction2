...
data_root = 'data/myvideo' 
data_root_val = 'data/myvideo' 
ann_file_train = 'data/myvideo/myvideo_train_list.txt'
ann_file_val = 'data/myvideo/myvideo_val_list.txt'
ann_file_test = 'data/myvideo/myvideo_val_list.txt'
